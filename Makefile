mytests: hash mytests.cpp HashMapTree.cpp HashMapTree.hpp RBTree.hpp RBTree.cpp customexceptions.hpp HashFunction.cpp HashFunction.hpp
	g++ -std=c++17 -c mytests.cpp -o mytests.o
	g++ -std=c++17 HashMapTree.o mytests.o RBTree.o RBTreeNode.o HashFunction.o -o mytests
	./myTests

hash: HashMapTree.cpp HashMapTree.hpp RBTree.hpp RBTree.cpp RBTreeNode.cpp RBTreeNode.hpp
